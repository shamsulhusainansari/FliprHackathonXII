...
public class HistoryActivity extends AppCompatActivity {
    ...
    private DataAdapter front_adapter;
    FirebaseAuth mAuth;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = notebookRef.orderBy("docId", Query.Direction.DESCENDING).whereEqualTo("dealerId",user.getUid());
        FirestoreRecyclerOptions<Data> options = new FirestoreRecyclerOptions.Builder<Data>()
                .setQuery(query, Data.class)
                .build();
        front_adapter = new DataAdapter(options);
